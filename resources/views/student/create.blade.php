                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="grade" class="form-control text-dark" id="grade" required>
                                        ...
                                        <option value="Inclusión escolar">Inclusión escolar</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="teacher" class="form-control text-dark" id="teacher" required>
                                        ...
                                        <option value="{{encrypt($item->teacherId)}}">{{$item->person->name}} {{$item->person->lastName}}</option>
                                        @endforeach
                                    </select>
                                    @error('teacher')
                                    <small class="text-danger">{{$message}}</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="disability" class="form-control text-dark" id="disability" required>
                                        ...
                                        <option value="{{encrypt($item->disabilityId)}}">{{$item->disabilityName}}</option>
                                        @endforeach
                                    </select>
                                    @error('disability')
                                    <small class="text-danger">{{$message}}</small>
