                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="grade" class="form-control text-dark" id="grade" required>
                                        ...
                                        <option value="Inclusión escolar" {{$student -> grade == 'Inclusión escolar' ? 'selected' : ''}}>Inclusión escolar</option>
                                        <option value="Otros casos" {{$student -> grade == 'Otros casos' ? 'selected' : ''}}>Otros casos</option>
                                    </select>
                                    @error('grade')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="teacher" class="form-control text-dark" id="teacher" required>
                                        <option selected value=""></option>
                                        @foreach ($teacher as $item)
                                        <option value="{{encrypt($item->teacherId)}}" {{$student->teacherId == $item->teacherId ? 'selected':''}}>{{$item->person->name}} {{$item->person->lastName}}</option>
                                        @endforeach
                                    </select>
                                    @error('teacher')
                                    <small class="text-danger">{{$message}}</small>
